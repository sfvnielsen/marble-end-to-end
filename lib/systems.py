    ...
    def __init__(self, sps, snr_db, baud_rate, learning_rate, batch_size, constellation, adc_bwl_relative_cutoff,
        ...
        if dac_bwl_relative_cutoff is not None:
            if use_brickwall:
                ...
                self.dac = BesselFilter(bessel_order=2, cutoff_hz=rrc_bw * dac_bwl_relative_cutoff, fs=1/self.Ts)
        ...
        if adc_bwl_relative_cutoff is not None:
            if use_brickwall:
                ...
                self.adc = BesselFilter(bessel_order=2, cutoff_hz=rrc_bw * adc_bwl_relative_cutoff, fs=1/self.Ts)
