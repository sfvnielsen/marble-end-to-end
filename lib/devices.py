...
class ElectroAbsorptionModulator(object):
    ...
    LINEAR_ABSORPTION_KNEE_POINTS_X = torch.flip(torch.Tensor([0.0, -1.0,  -2.0, -4.0]), (0,))  # driving voltage
    LINEAR_ABSORPTION_KNEE_POINTS_Y = torch.flip(torch.Tensor([0.0, 1.0,   2.0,  4.0]), (0,))  # absorption in dB
...
class Photodiode(object):
    ...
    def __init__(self, responsivity, temperature, dark_current,
                 impedance_load, bandwidth, Fs, sps) -> None:
