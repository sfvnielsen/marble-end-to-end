...
class SingleModeFiber(object):
    ...
    def __init__(self, fiber_length, attenutation, dispersion_slope,
                 zero_dispersion_wavelength, carrier_wavelength, Fs) -> None:

        # Add properties from constructor
        self.fiber_length = fiber_length
        self.attenuation = attenutation
        self.carrier_wavelength = carrier_wavelength
        self.Fs = Fs

        # Calculate parameters based on inputs
        # Covnvert zero_dispersion_wavelength and carrier_wavelength to dispersion parameter (cf. Liang and Kahn, 2023)
